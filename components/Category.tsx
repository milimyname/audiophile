  ...
  return (
    <div className='flex justify-between gap-x-6'>
        <div className='relative flex-1'>
            <NextPicture css='absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%]' 
                         url='/shared/desktop/image-category-thumbnail-headphones.png'
                         alt='Headphones' width={180} height={200}/>
        ...
        <div className='relative flex-1'>
            <NextPicture css='absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%]' 
                         ...
                         alt='Speakers' width={200} height={210}/>
            <div className='text-center text-black uppercase bg-gray rounded-xl mt-44 pt-52 pb-4'>
        ...
        <div className='relative flex-1'>
            <NextPicture css='absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%]' 
                         ...
                         alt='Earphones' width={180} height={150}/>
            <div className='text-center text-black uppercase bg-gray rounded-xl mt-44 pt-52 pb-4'>
